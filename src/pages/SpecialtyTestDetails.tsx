...
const SpecialtyTestDetails: React.FC = () => {
  const { testId } = useParams();
  const { addItem } = useCart();
  const { showNotification } = useNotification();

  // Find the test data based on the testId
  const testData = specialtyTests.find(test => test.id === Number(testId));
...
export default SpecialtyTestDetails;
